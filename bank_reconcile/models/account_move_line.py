...
class account_move_line(models.Model):
    ...
    def onchange_rapprocher_move(self,cr,uid,ids,rapprocher,context=None):
        ...
        if context['reconciliation_id'] :
            domain=[('account_move_line_id','=',move_line.id),('reconciliation_id','=',context['reconciliation_id'])]
            if rapprocher :
                    if not relation_obj.search(cr,uid,domain) :
                        relation_obj.create(cr,uid,{'account_move_line_id':move_line.id,'reconciliation_id':context['reconciliation_id']})
